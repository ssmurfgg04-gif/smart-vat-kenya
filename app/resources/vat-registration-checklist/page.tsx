...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "kra vat registration requirements 2026",
    "vat registration checklist kenya",
    "kra pin for vat documents",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=I%20read%20the%20VAT%20Registration%20Checklist%20and%20I%20want%20to%20register."
            target="_blank" rel="noopener noreferrer"
