...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "vat on digital marketplace kenya",
    "non resident vat registration kenya",
    "vat on saas kenya",
    ...
    <>
      ...
      <div className="max-w-[880px] mx-auto px-6 lg:px-10 py-12">
            ...
            <section id="input-vat" aria-labelledby="input-vat-h">
              ...
              <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
                ...
                <p>
                  ...
                  <Link href="/resources/input-vat-deduction-guide" className="text-brand underline underline-offset-2 hover:text-brand-hover">Input VAT Deduction Guide</Link>.
                </p>
              </div>
            </section>
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=I%20need%20help%20with%20VAT%20for%20my%20digital%20services%20business"
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-brand text-canvas font-semibold text-sm px-5 py-3 rounded-md hover:bg-brand-hover transition-colors"
          >
            Get Digital VAT Help
