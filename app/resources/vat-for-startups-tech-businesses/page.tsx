...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "do startups pay vat kenya",
    "saas vat kenya",
    "software company vat kenya",
    "ecommerce vat kenya",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=I%20read%20your%20VAT%20for%20startups%20guide%20and%20I%20need%20help%20with%20my%20tech%20business%20VAT."
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-brand text-canvas font-semibold text-sm px-5 py-3 rounded-md hover:bg-brand-hover transition-colors"
          >
            Get Startup VAT Help
