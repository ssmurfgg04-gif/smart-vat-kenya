...
export const metadata: Metadata = constructMetadata({
  ...
  absoluteTitle: true,
  description:
    "Complete eTIMS compliance checklist for VAT-registered businesses in Kenya. Daily invoicing requirements, monthly data submission, stock reconciliation, device maintenance, and annual obligations.",
  path: "/resources/etims-compliance-checklist",
  keywords: [
    "etims compliance checklist kenya",
    "etims daily obligations",
    "etims monthly submission requirements",
    "etims stock reconciliation",
    "etims device maintenance",
    "kra etims compliance requirements 2026",
    "etims invoice continuity check",
    "etims compliance for vat businesses",
  ],
  type: "article",
})
