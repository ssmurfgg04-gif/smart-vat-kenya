...
export const metadata: Metadata = constructMetadata({
  title: "eTIMS Down? How to Invoice Offline and Sync When KRA eTIMS Is Not Working 2026",
  absoluteTitle: true,
  description:
    "KRA eTIMS is down? Here is how to generate invoices offline in eTIMS Client, what to do when eTIMS Lite is not loading, how to sync offline invoices when the portal comes back, and how to avoid KES 50,000/month penalties during an outage.",
  path: "/resources/etims-down-offline-invoicing",
  keywords: [
    "etims down",
    "kra etims not working",
    "etims offline invoicing",
    "etims client offline mode",
    "etims lite not loading",
    "kra etims down today",
    "etims outage kenya",
    "etims server error",
    "how to invoice when etims is down",
    "etims sync offline invoices",
  ],
  type: "article",
})
