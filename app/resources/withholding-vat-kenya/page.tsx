...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "kra withholding vat rate",
    "withholding vat agents kenya",
    "withholding vat refund kenya",
    ...
    <>
      ...
      <div className="max-w-[880px] mx-auto px-6 lg:px-10 py-12">
          ...
          <div className="space-y-10">
            ...
            <section id="refunds" aria-labelledby="refunds-h">
              ...
              <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
                ...
                <p>
                  See our <Link href="/resources/vat-refund-guide-kenya" className="text-brand underline underline-offset-2 hover:text-brand-hover">VAT Refund Guide</Link> for the full process.
                </p>
              </div>
            </section>
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=I%20need%20help%20with%20withholding%20VAT"
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-brand text-canvas font-semibold text-sm px-5 py-3 rounded-md hover:bg-brand-hover transition-colors"
          >
            Get Withholding VAT Help
