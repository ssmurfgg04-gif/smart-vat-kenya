...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "common itax errors kenya",
    "itax portal timeout error",
    "itax invalid pin or password",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=Hi%2C%20I%20need%20help%20with%20iTax%20errors%20%E2%80%94%20I%20want%20to%20stop%20dealing%20with%20the%20portal%20myself."
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-brand text-canvas font-semibold text-sm px-5 py-3 rounded-md hover:bg-brand-hover transition-colors"
          >
            Auto-Filing — KES 3,500/month
            <ArrowRight size={14} weight="bold" aria-hidden="true" />
          </a>
        </div>
      </div>
