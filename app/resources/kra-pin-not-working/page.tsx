...
export const metadata: Metadata = constructMetadata({
  ...
  absoluteTitle: true,
  description:
    "Your KRA PIN application or activation is not working? Common issues: PIN already exists, KRA PIN not found on iTax, verification not arriving, errors on Huduma Centre applications, document rejection, and how to fix each one.",
  path: "/resources/kra-pin-not-working",
  keywords: [
    "kra pin not working",
    "kra pin application stuck",
    "kra pin already exists",
    "kra pin not found itax",
    "kra pin verification problem",
    "kra pin activation failed",
    "how to fix kra pin error",
    "kra pin application rejected",
  ],
  type: "article",
})
            ...
            <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
              ...
              <div className="border border-hairline rounded-lg p-4 bg-canvas-alt flex items-start gap-3">
                ...
                <p className="text-[0.83rem] text-ink-muted leading-relaxed">
                  <strong className="text-ink">Heads up:</strong> If you retrieve your PIN and want to register for VAT, see our <Link href="/resources/vat-registration-checklist" className="text-brand underline underline-offset-2 hover:text-brand-hover">VAT registration checklist</Link> for the documents you will need.
                </p>
              </div>
            </div>
          </section>
