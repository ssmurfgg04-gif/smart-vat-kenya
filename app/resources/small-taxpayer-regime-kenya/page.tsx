...
export const metadata: Metadata = constructMetadata({
  ...
  absoluteTitle: true,
  description:
    "Kenya's small taxpayer regime explained. KES 5 million VAT threshold, turnover tax (1-3%) for businesses under KES 5M, eTIMS requirements for all businesses regardless of size, and how small businesses can claim input VAT through voluntary registration.",
  path: "/resources/small-taxpayer-regime-kenya",
  keywords: [
    "small taxpayer regime kenya",
    "small taxpayer kenya vat",
    "kenya vat threshold small business",
    "turnover tax vs vat kenya small business",
    "voluntary vat registration kenya",
    "kes 5 million threshold kenya",
    "small business tax kenya",
    "kenya tax regimes comparison",
  ],
  type: "article",
})
        ...
        <article className="space-y-14">
            ...
            <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
              ...
              <div className="border border-hairline rounded-lg p-4 bg-canvas-alt flex items-start gap-3">
                ...
                <p className="text-[0.83rem] text-ink-muted leading-relaxed">
                  ...
                  <Link href="/resources/finance-act-vat-changes-kenya" className="text-brand underline underline-offset-2 hover:text-brand-hover">
          ...
          <section id="thresholds" aria-labelledby="thresholds-h">
            ...
            <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
              ...
              <p>
                ...
                <Link href="/resources/vat-vs-turnover-tax" className="text-brand underline underline-offset-2 hover:text-brand-hover">
          ...
          <section id="etims" aria-labelledby="etims-h">
            ...
            <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Failing to register for or use eTIMS attracts a penalty of KES 50,000 per month, even if you are on turnover tax. KRA has been conducting compliance checks since January 2026.",
                  },
                  {
              ...
              <p>
                See our{" "}
                <Link href="/resources/etims-onboarding-guide" className="text-brand underline underline-offset-2 hover:text-brand-hover">
          ...
          <section id="voluntary-vat" aria-labelledby="voluntary-vat-h">
            ...
            <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
              ...
              <p>
                ...
                <Link href="/resources/do-i-need-to-register-for-vat-kenya" className="text-brand underline underline-offset-2 hover:text-brand-hover">
