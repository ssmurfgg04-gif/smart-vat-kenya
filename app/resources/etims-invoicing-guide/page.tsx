...
export const metadata: Metadata = constructMetadata({
  ...
  keywords: [
    ...
    "how to create etims invoice",
    "etims qr code verification",
    "etims invoice fields kenya",
        ...
        <article className="space-y-14">
          ...
          <section id="supplier-not-on-etims" aria-labelledby="supplier-not-on-etims-h">
            ...
            <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
              ...
              <p>
                See our{" "}
                <Link href="/resources/vat-special-table-risks" className="text-brand underline underline-offset-2 hover:text-brand-hover">
