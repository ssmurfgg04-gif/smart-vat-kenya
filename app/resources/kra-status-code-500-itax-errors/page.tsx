...
export const metadata: Metadata = constructMetadata({
  title: "KRA Status Code 500 iTax Errors — Causes and Fixes 2026",
  absoluteTitle: true,
  description:
    "KRA iTax Error 500 means the portal server is down or overloaded. Here is why it happens during Kenya's tax season, how to check if it's a KRA outage, and what to do when you get a blank white page or 500 Internal Server Error on itax.kra.go.ke.",
  path: "/resources/kra-status-code-500-itax-errors",
  keywords: [
    "kra status code 500",
    "itax error 500",
    "kra itax internal server error",
    "itax blank white page",
    "kra portal 500 error today",
    "itax 500 internal server error fix",
    "kra itax server down",
    "kra itax error 500 kenya",
  ],
  type: "article",
})
