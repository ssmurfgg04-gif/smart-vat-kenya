...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "kra vat registration 2026",
    "itax vat registration steps",
    "documents required for vat registration kenya",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <article className="space-y-14">
          ...
          <section id="how-to" aria-labelledby="how-to-h">
            ...
            <div className="mt-7 border border-brand/20 bg-brand-muted rounded-lg p-5">
              ...
              <a
                href="https://wa.me/254721725958?text=I%20need%20help%20registering%20for%20VAT%20on%20iTax"
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=I%20read%20your%20VAT%20registration%20guide%20and%20I%20need%20help."
            target="_blank" rel="noopener noreferrer"
