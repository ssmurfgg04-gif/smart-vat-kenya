...
export const metadata: Metadata = constructMetadata({
  title: "VAT for NGOs in Kenya 2026 | Exemptions & Compliance Guide",
  absoluteTitle: true,
  description:
    "NGO VAT guide Kenya 2026. Which goods and services are VAT-exempt for NGOs, how to claim input VAT refunds, import duty exemptions, and common compliance mistakes to avoid.",
  path: "/resources/vat-for-ngos-kenya",
  keywords: [
    "vat for ngos kenya",
    "ngo vat exemption kenya",
    "vat exemptions charitable organizations kenya",
    "kra vat rules ngos",
    "input vat refund ngo kenya",
    "vat on donations kenya",
    "ngo tax compliance kenya",
    "kra vat exemption certificate ngo",
  ],
  type: "article",
})
