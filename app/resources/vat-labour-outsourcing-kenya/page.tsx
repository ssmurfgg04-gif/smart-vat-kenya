      ...
      <div className="max-w-[700px] mx-auto px-6 lg:px-10 py-12">
        ...
        <div className="space-y-5 text-[0.9rem] text-ink-soft leading-[1.75]">
          ...
          <ol className="space-y-3 list-decimal list-inside">
            ...
            <li className="text-ink-soft">
              <strong className="text-ink">File monthly VAT returns</strong> via iTax by the 20th of each following month. See our <Link href="/resources/how-to-file-vat-return-on-itax" className="text-brand underline underline-offset-2 hover:text-brand-hover">filing guide</Link>.
            </li>
          </ol>
        ...
        <div className="mt-14 pt-8 border-t border-hairline flex items-center justify-between flex-wrap gap-4">
          ...
          <a
            href="https://wa.me/254721725958?text=I%20need%20help%20with%20VAT%20on%20outsourced%20staff"
            target="_blank" rel="noopener noreferrer"
