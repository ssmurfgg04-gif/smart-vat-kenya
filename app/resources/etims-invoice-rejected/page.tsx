...
export const metadata: Metadata = constructMetadata({
  ...
  absoluteTitle: true,
  description:
    "Your eTIMS invoice was rejected? Reasons why KRA rejects e-invoices: wrong ITAX or DIGITAL signature, control unit errors, duplicate serial numbers, customer PIN validation fails, and how to fix each rejection code.",
  path: "/resources/etims-invoice-rejected",
  keywords: [
    "etims invoice rejected",
    "etims invoice rejected itax signature",
    "kra rejected my etims invoice",
    "etims control unit error",
    "etims duplicate invoice number",
    "etims customer pin validation failed",
    "how to fix etims invoice rejection",
    "etims invoice error codes",
  ],
  type: "article",
})
