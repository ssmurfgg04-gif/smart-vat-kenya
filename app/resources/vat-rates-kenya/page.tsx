...
export const metadata: Metadata = constructMetadata({
  ...
  keywords: [
    ...
    "zero rated supplies kenya",
    "exempt supplies kenya",
    "what is vat rate in kenya",
              ...
              <div className="space-y-4 text-[0.9rem] text-ink-soft leading-[1.75]">
                ...
                <div className="border border-brand/25 bg-brand-muted rounded-lg p-4 flex items-start gap-3 mt-4">
                  ...
                  <p className="text-[0.83rem] text-ink-soft leading-relaxed">
                    ...
                    <Link href="/resources/how-to-calculate-vat-in-kenya" className="text-brand underline underline-offset-2 hover:text-brand-hover">
