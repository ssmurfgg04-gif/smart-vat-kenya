...
export const metadata: Metadata = constructMetadata({
  ...
  absoluteTitle: true,
  description:
    "VAT rules for construction and real estate in Kenya. Court of Appeal 2025 ruling on commercial property sales, withholding VAT on construction services, mixed-use apportionment, and subcontractor obligations.",
  path: "/resources/vat-for-construction-real-estate-kenya",
  keywords: [
    "vat construction kenya",
    "vat real estate kenya",
    "commercial property vat kenya",
    "withholding vat construction kenya",
    "vat on property sales kenya",
    "vat contractors kenya",
    "mixed-use development vat apportionment",
    "kra vat construction services",
  ],
  type: "article",
})
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="mt-10 border border-brand/20 bg-brand-muted rounded-lg p-6 text-center">
          ...
          <a
            href="https://wa.me/254721725958?text=Hi%2C%20I%20need%20help%20with%20VAT%20for%20construction%20or%20real%20estate"
