...
export const metadata: Metadata = constructMetadata({
  ...
  absoluteTitle: true,
  description:
    "Step-by-step checklist for filing your monthly VAT return on KRA iTax. What documents to prepare, common errors to avoid, data validation checks, and post-filing confirmation steps.",
  path: "/resources/vat-return-filing-checklist",
  keywords: [
    "vat return filing checklist kenya",
    "monthly vat return checklist",
    "how to file vat return correctly",
    "vat return data checklist",
    "kra vat filing steps",
    "vat return common mistakes kenya",
    "vat return documents needed",
    "itax vat return preparation",
  ],
  type: "article",
})
