...
export const metadata: Metadata = constructMetadata({
  title: "Tax Compliance Certificate Kenya 2026 — How to Apply for KRA TCC on iTax",
  absoluteTitle: true,
  description:
    "Complete guide to getting your KRA Tax Compliance Certificate (TCC) in Kenya. Requirements, iTax application steps, eTIMS compliance, validity, and common reasons for rejection. Free to apply.",
  path: "/resources/tax-compliance-certificate-kenya",
  keywords: [
    "tax compliance certificate kenya",
    "kra tcc",
    "tax clearance certificate kenya",
    "how to apply for tcc kenya",
    "kra tax compliance certificate requirements",
    "tcc kenya itax",
      ...
      <div className="max-w-[700px] mx-auto px-6 lg:px-10 py-12">
        ...
        <article>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <p>
              <Link href="/services/vat-registration" className="text-brand font-medium hover:underline inline-flex items-center gap-1">
