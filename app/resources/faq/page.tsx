...
const faqs = [
  ...
  { q: "What is the penalty for late VAT filing in Kenya?", a: "KRA imposes a fixed KES 10,000 penalty for late VAT filing, plus 5% of the tax due (whichever is higher), plus 1% interest per month on unpaid tax. VAT returns must be filed by the 20th of each following month." },
  ...
  { q: "What is the penalty for not registering for VAT in Kenya?", a: "The KRA penalty for failure to register for VAT when required is KES 100,000 per month. This is separate from the KES 10,000 late-filing penalty." },
  ...
  { q: "Is the VAT threshold KES 5 million or KES 8 million?", a: "The KES 5 million threshold remains the primary reference. The Finance Act 2025 introduced amendments. Contact Smart VAT Kenya for current threshold confirmation for your business." },
  ...
  { q: "What is the eTIMS penalty for non-compliance?", a: "KES 50,000 per month for basic non-compliance. If your system integration fails, the penalty jumps to KES 500,000 per month. This is separate from standard VAT penalties." },
  ...
  { q: "What is the VAT treatment of bad debts?", a: "You can claim bad debt relief on VAT previously accounted for on unpaid sales. The Finance Act 2025 reverted the relief period to 3 years." },
]
