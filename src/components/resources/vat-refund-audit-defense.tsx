    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-10">
        ...
        <div className="bg-brand-muted rounded-lg p-6 text-center">
          ...
          <a href="mailto:info@smartvatkenya.co.ke?subject=Hi%2C%20I%20need%20help%20with%20a%20VAT%20refund%20or%20audit%20defense" className="inline-flex items-center gap-2 bg-brand text-canvas font-semibold px-6 py-3 rounded-md hover:bg-brand-hover transition-colors">
            Get Audit Defense <ArrowRight size={14} weight="bold" />
          </a>
        </div>
