...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "VAT for Landlords Kenya 2026", item: "https://smartvatkenya.co.ke/resources/vat-for-landlords-kenya/" },
  ],
}
          ...
          <div className="border border-brand/25 bg-brand-muted rounded-lg p-5 mt-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:info@smartvatkenya.co.ke?subject=I%20need%20help%20with%20VAT%20for%20my%20rental%20property"
