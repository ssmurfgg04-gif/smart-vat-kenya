    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-10">
        ...
        <div className="bg-brand-muted rounded-lg p-6 text-center">
          ...
          <a href="mailto:info@smartvatkenya.co.ke?subject=Hi%2C%20I%20want%20to%20discuss%20robust%20eTIMS%20and%20compliance%20architecture" className="inline-flex items-center gap-2 bg-brand text-canvas font-semibold px-6 py-3 rounded-md hover:bg-brand-hover transition-colors">
            Talk to Our Engineering Team <ArrowRight size={14} weight="bold" />
          </a>
        </div>
