...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer" as const, text: "You lose your session data and have to start over. Smart VAT Kenya handles portal friction for you entirely by email." }
    }
  ]
}
          ...
          <table className="w-full text-[0.83rem]">
            ...
            <tbody className="divide-y divide-hairline">
              ...
              <tr>
                ...
                <td className="p-3.5 text-ink font-semibold">Email (replies fast)</td>
              </tr>
            </tbody>
          </table>
        </div>
