...
const faqs = [
  ...
  { q: "What is the eTIMS penalty for non-compliance?", a: "Issuing a non-compliant electronic tax invoice attracts the higher of KES 1,000,000 or 10% of the tax involved per invoice (Tax Procedures (Electronic Tax Invoice) Regulations, LN 64/2024). Failing to keep or issue the required invoices is exposed to TPA s.86 (higher of KES 100,000 or twice the tax), and failing to integrate your system after a KRA notice costs KES 500,000 per month. This is separate from standard VAT penalties." },
