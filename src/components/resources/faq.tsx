...
const faqs = [
  ...
  { q: "Does eTIMS let KRA see my phone, computer or WhatsApp?", a: "No. eTIMS transmits the invoice data you enter — seller and buyer PINs, date, description, quantity, price, tax, and a validation QR code. It does not read other apps, files, calls or messages. Beyond your filings, KRA works from statutory records it is lawfully allowed to collect: eTIMS transactions, withholding tax certificates, customs and employment records." },
  { q: "Is all the money in my M-Pesa or bank account taxed?", a: "Money in an account is not income. Transfers, gifts, savings and family support are not taxable on their own. What is taxable is income you earn and fail to declare — and that is what KRA validates against its records of eTIMS invoices, withholding tax and returns. File truthfully and the picture is fine; file nothing while records show otherwise and the mismatch is the risk." },
  { q: "If I issued eTIMS invoices during the year, can I still file a nil return?", a: "No — KRA's systems cross-reference nil and non-filers against eTIMS, withholding and customs data, and that check is exactly what the 2026 compliance push runs on. If you transacted, file the accurate return (which often still means little or no tax below the thresholds)." },
  { q: "Can I claim fuel as a business expense?", a: "Yes, if the vehicle is registered in the business's name and the fuel purchase is backed by an eTIMS fuel receipt carrying your business PIN. Till receipts and handwritten dockets are proof of payment, not a claimable tax document. Fuel is now on the eTIMS fuel module — the mandatory rollout finished December 2025 and receipts may be issued at the pump for both individual motorists and businesses; around 500 stations (16% of the country) were live by early 2026, so a station that cannot issue yet is mid-onboarding." },
  { q: "How do I claim Safaricom internet or airtime as a business expense?", a: "Safaricom operates an official KRA compliance channel on its business portal (business.safaricom.co.ke/kra) — submit your business KRA PIN once and Safaricom's invoices are transmitted to iTax in real time with your PIN. Keep M-Pesa payment records as supporting evidence either way." },
  { q: "Can I claim KPLC electricity tokens as a business expense?", a: "Claim the bill and tokens only where the meter registration matches the party bearing the cost — if the meter and bill belong to your business, they support the claim and the tokens count as proof of payment. If you use a landlord's meter on rented premises, ask the owner to register the meter to you or issue a rental tax invoice, or the claim is not yours to make." },
  { q: "Can I claim rent without a receipt?", a: "Rent is claimable where the landlord issues an eTIMS-compliant rental invoice bearing your PIN. Landlords earning KES 288,000–15 million a year in rent sit under Monthly Rental Income (MRI: 7.5% on gross rent since January 2024), and KRA is onboarding that base onto eTIMS so tenants can claim — some landlords already issue monthly eTIMS rental invoices. If your landlord refuses, make the ask in writing and keep every documented payment trail (M-Pesa reference, bank transfer)." },
  { q: "Are M-Pesa till receipts valid for input VAT or expense deductions?", a: "No — they are proof of payment only. VAT input claims and expense deductions require an eTIMS-compliant invoice from the supplier that carries your KRA PIN. Keep both documents: M-Pesa for payment, eTIMS for the claim." },
  { q: "Why do I see \"wrong obligation ID\" or \"NONVAT only\" when creating an eTIMS invoice?", a: "This error means your iTax obligations and eTIMS registration are out of sync — for example, you picked a NONVAT invoice while no matching NONVAT obligation is active, or e-invoicing is not activated on that PIN yet (the activation error reads 'inactive/invalid PIN number'). Fix it by reviewing your obligations in iTax, registering the correct one (VAT / Income Tax – Business), and activating eTIMS for that PIN. If it persists, KRA eTIMS support (+254 711 099 999 / etims-support@kra.go.ke) activates or adjusts — usually within 1–2 working days." },
  { q: "Can I claim Facebook or Google ads, or AI subscriptions, without an eTIMS receipt?", a: "Foreign providers do not issue KRA eTIMS invoices, so keep provider contracts and invoices plus the payment trail for these subscriptions — those are documentary support. Local claims still need eTIMS. This area changes frequently (digital services taxes apply), so check with an advisor rather than assuming." },
  { q: "Do I still need accounting software if I use eTIMS?", a: "Not for compliance alone — eTIMS Lite covers invoicing. But a bookkeeping tool (Zoho Books, QuickBooks, etc.) still handles the rest: receipts, profit, reporting, finance hygiene. Many businesses run eTIMS and accounting software side by side; the eTIMS invoices are the tax layer, the software is the business layer." },
]
