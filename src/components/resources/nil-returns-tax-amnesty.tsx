...
const wa = (t: string) => "mailto:info@smartvatkenya.co.ke?subject=%24%7BencodeURIComponent%28t%29%7D"
      ...
      <main className="max-w-[860px] mx-auto px-6 lg:px-10 py-16 lg:py-20">
        ...
        <header className="mb-12">
          ...
          <p className="text-[0.92rem] text-ink-muted leading-relaxed max-w-[58ch]">
            ...
            including a complete <strong className="text-ink">vat nil return filing</strong> walkthrough.
            </p>
