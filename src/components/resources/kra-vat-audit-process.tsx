        ...
        <div className="space-y-5 text-[0.9rem] text-ink-soft leading-[1.75]">
          ...
          <div className="space-y-4 mt-4">
            {[
              ...
              { finding: "Missing eTIMS invoices", prevalence: "Very common", explanation: "If you issued invoices outside eTIMS — even for cash sales — KRA treats those as undeclared sales. Each non-compliant invoice is exposed to the higher of KES 1,000,000 or 10% of the tax under the ETI Regulations (LN 64/2024), plus TPA s.86 exposure." },
