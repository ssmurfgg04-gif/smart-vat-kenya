...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "KRA VAT Audit Process Kenya 2026", item: "https://smartvatkenya.co.ke/resources/kra-vat-audit-process/" },
  ],
}
        ...
        <div className="space-y-5 text-[0.9rem] text-ink-soft leading-[1.75]">
          ...
          <div className="space-y-4 mt-4">
            {[
              ...
              { finding: "Missing eTIMS invoices", prevalence: "Very common", explanation: "If you issued invoices outside eTIMS - even for cash sales - KRA treats those as undeclared sales. Each non-compliant invoice is exposed to the TPA s.86 penalty (the higher of 5% of the tax due, KES 100,000 for companies, or KES 10,000 for individuals)." },
          ...
          <div className="border border-brand/25 bg-brand-muted rounded-lg p-5 mt-8">
            ...
            <a href="mailto:info@smartvatkenya.co.ke?subject=I%20need%20help%20with%20a%20KRA%20VAT%20audit%20-%20document%20preparation%20and%20representation"
