...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "eTIMS Penalty KES 50,000 Per Month in Kenya", item: "https://smartvatkenya.co.ke/resources/etims-penalty-50000-per-month-kenya" },
  ],
}
