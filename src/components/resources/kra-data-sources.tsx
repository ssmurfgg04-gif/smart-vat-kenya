    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-10">
        ...
        <div className="bg-brand-muted rounded-lg p-8 text-center space-y-4">
          ...
          <a
            href="mailto:info@smartvatkenya.co.ke?subject=Hi%2C%20I%20want%20to%20understand%20what%20the%20latest%20KRA%20data%20means%20for%20my%20VAT."
          ...
          >
            Ask Us by Email <ArrowUpRight size={14} weight="bold" />
          </a>
        </div>
