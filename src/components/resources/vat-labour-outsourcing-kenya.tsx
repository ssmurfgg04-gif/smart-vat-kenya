      ...
      <div className="max-w-[700px] mx-auto px-6 lg:px-10 py-12">
        ...
        <div className="space-y-5 text-[0.9rem] text-ink-soft leading-[1.75]">
          ...
          <div className="border border-brand/25 bg-brand-muted rounded-lg p-5 mt-8">
            ...
            <a href="mailto:info@smartvatkenya.co.ke?subject=I%20need%20help%20with%20VAT%20on%20labour%20outsourcing%20under%20the%20Finance%20Act%202026"
              ...
              Contact Us by Email <ArrowRight size={14} weight="bold" aria-hidden="true" />
            </a>
          </div>
