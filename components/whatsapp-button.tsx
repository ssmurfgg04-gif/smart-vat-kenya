export function WhatsAppButton() {
  return (
    <>
      ...
      <a
        href="https://wa.me/254717344440?text=Hi%2C%20I%27d%20like%20a%20quote%20for%20VAT%20registration%20or%20monthly%20filing%20in%20Kenya."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Get a quote for VAT services on WhatsApp - +254 717 344 440"
      ...
      >
        ...
        <span className="whitespace-nowrap">Get a Quote on WhatsApp</span>
      </a>
      ...
      <div className="sm:hidden fixed bottom-0 inset-x-0 z-50 bg-white border-t border-hairline px-4 py-3 pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] flex items-center justify-between gap-3">
        <p className="text-[0.82rem] font-medium text-[#14243e] leading-snug">VAT services from KES 5,000</p>
        <a
          href="https://wa.me/254717344440?text=Hi%2C%20I%27d%20like%20a%20quote%20for%20VAT%20services"
          target="_blank"
          rel="noopener noreferrer"
          data-track="whatsapp-cta"
