...
const articles: Resource[] = [
  ...
  { slug: "etims-vs-shuru-comparison", title: "eTIMS vs KRA Shuru Chatbot: What Each Does" },
  ...
  { slug: "vat-deadline-reminders", title: "Free KRA VAT Deadline Reminders" },
  ...
  { slug: "kra-health-check", title: "Free KRA Status & Ledger Health Check" },
  { slug: "vat-threshold-explainer", title: "VAT Threshold Kenya: KES 5M or 8M? The Real Answer" },
  { slug: "how-to-create-kra-pin", title: "How to Create a KRA PIN Online in Kenya" },
  { slug: "vat-input-guide", title: "VAT Input Tax in Kenya: Complete Claim & eTIMS Guide" },
  { slug: "etims-device-not-registered", title: "eTIMS Device Not Registered - How to Activate on KRA" },
  { slug: "etims-cu-pin-invalid", title: "eTIMS CU PIN Invalid or Blocked - How to Reset" },
  { slug: "etims-duplicate-invoice", title: "eTIMS Duplicate Invoice Error - Why & How to Fix" },
  { slug: "etims-buyer-pin-missing", title: "eTIMS Buyer PIN Missing or Invalid - B2B Invoicing" },
  { slug: "vat-return-dispute-auto-populated", title: "How to Dispute a Wrong Auto-Populated VAT Return" },
  { slug: "vat-ledger-explained-kenya", title: "KRA VAT Ledger Explained - What KRA Sees" },
  { slug: "vat-auto-population-input-tax-credit", title: "Auto-Populated Input VAT - Claim Your Full Credit" },
]
